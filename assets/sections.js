angular.module('cafapi.templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('showcase/en-us/services/aspects.md',
    "Aspects is the only open source user interface framework for building modern, responsive, mobile big data applications on the web. \r" +
    "\n" +
    "\r" +
    "\n" +
    "Aspects provides all of the essentials required for your big data project, allowing you to swiftly create dashboards and reports that provide users with the\r" +
    "\n" +
    "insights they crave from their big data applications. Aspects is based on best-of-breed, open source technologies, including Angular 4,\r" +
    "\n" +
